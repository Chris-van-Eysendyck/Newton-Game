...
export class Level3 extends Phaser.Scene {
    ...
    constructor() {
        super('Level3');
        console.log('Level3 constructor called');
    }

    preload() {
        console.log('Level3 preload started');
        ...
        console.log('Level3 preload complete');
    }

    create() {
        console.log('Level3 create started');
    ...
    generateSplitProblem() {
        // Generate a number to split (5-10 for easier learning)
        this.topNumber = Phaser.Math.Between(5, 10);
    ...
    trackGameStart() {
        fetch('https://api.countapi.xyz/hit/newton-game/level3-starts')
            .then(res => res.json())
            .then(data => console.log('Level 3 starts:', data.value))
    ...
    trackLevelComplete() {
        fetch('https://api.countapi.xyz/hit/newton-game/level3-completions')
            .then(res => res.json())
            .then(data => console.log('Level 3 completions:', data.value))
            .catch(err => console.log('Analytics unavailable'));
    }
}